...
public class ZShape extends JPanel implements TetrisShape
{
     protected Block[][] gridShape;
     private JPanel shapePanel;

     public ZShape(int side, Color color)
     {
	...
	//set up initial Z shaped block
	gridShape[0][0] = new Block(side, color, false, false);
	...
	gridShape[2][2] = new Block(side, color, true, false);
	...
	System.out.println("Figure how to move vertically later");
     ...
     {
	if(gridShape[0][1].isActive == false)
	{
	...
	else if(gridShape[0][1].isActive == true)
	{
