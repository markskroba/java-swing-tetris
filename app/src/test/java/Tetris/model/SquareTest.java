...
public class SquareTest
{
	...
	{
		color=Color.blue;
		tempColor = square.blockArray.get(0).get(4).getColor();
	...
	{
		color=Color.blue;
		tempColor = square.blockArray.get(0).get(5).getColor();
		assertEquals("Block should be visible", color, tempColor );
	}
	...
	{
		color=Color.blue;
		tempColor = square.blockArray.get(1).get(4).getColor();
		assertEquals("Block should be visible", color, tempColor );
	}
	...
	{
		color=Color.blue;
		tempColor = square.blockArray.get(1).get(5).getColor();
		assertEquals("Block should be visible", color, tempColor );
	}
}
